    ...
    <div>
      <section className="bg-gradient-to-r from-green-500 to-green-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-center text-green-100">We'd love to hear from you</p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+254708192030" className="text-green-600 hover:text-green-700">
                      +254 708 192 030
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:kabatiflyoverschool@gmail.com" className="text-green-600 hover:text-green-700">
