...
const colorMap: Record<string, { badge: string; icon: string; border: string; highlight: string }> = {
  green: {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filtered.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className={`group relative bg-white rounded-2xl shadow-sm border border-gray-100 p-6 overflow-hidden
